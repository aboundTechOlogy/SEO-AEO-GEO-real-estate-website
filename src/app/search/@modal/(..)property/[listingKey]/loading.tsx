export default function InterceptedPropertyLoading() {
  return (
    <div className="fixed inset-0 z-[150]">
      ...
      <aside className="fixed inset-0 md:inset-y-0 md:left-[25px] md:right-[25px] min-[1300px]:left-1/2 min-[1300px]:right-auto min-[1300px]:w-[1200px] min-[1300px]:-translate-x-1/2 border-0 md:border md:border-black/15 bg-[#f5f5f5] shadow-[0_24px_70px_rgba(0,0,0,0.45)]">

        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row gap-16">
            ...
            <div className="flex-1">
              <p className="text-gray-500 text-sm uppercase tracking-[0.2em] mb-2">Andrew Whalen</p>
              <h2 className="font-playfair text-4xl md:text-5xl uppercase tracking-wider text-[#1a1a1a] mb-4">
                  ...
                  <button
                    ...
                    className={`px-5 py-2 text-sm uppercase tracking-wider border transition-all ${
                      goal === g
                        ...
                        : "border-gray-300 text-[#1a1a1a] hover:border-gray-400"
                    }`}
                  >
                    {g}
                  </button>
              ...
              {status === "sent" ? (
                <div className="py-12 text-center">
                  <p className="font-playfair text-2xl text-[#1a1a1a] mb-2">Thank you.</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <input name="firstName" placeholder="First Name *" required
                      className="w-full bg-transparent border-b border-gray-200 focus:border-gray-400 px-0 py-3 text-[#1a1a1a] placeholder-gray-400 text-sm outline-none transition-colors" />
                  ...
                  <textarea name="message" placeholder="Message" rows={4}
                    className="w-full bg-transparent border-b border-gray-200 focus:border-gray-400 px-0 py-3 text-[#1a1a1a] placeholder-gray-400 text-sm outline-none transition-colors resize-none" />

                  <div className="flex items-start gap-3 pt-2">
                    <input type="checkbox" name="consent" required id="consent-contact" className="mt-1 accent-[#1a1a1a]" />
                    <label htmlFor="consent-contact" className="text-gray-500 text-xs leading-relaxed">
                      ...
                      and{" "}
                      <a href="/terms/" className="underline hover:text-[#1a1a1a]">Terms of Service</a>.
                    </label>
                  </div>

                  <div className="pt-4">
                    <button type="submit" disabled={status === "sending"}
                      className="bg-[#1a1a1a] rounded-full px-10 py-3.5 text-sm uppercase tracking-wider text-white hover:bg-[#333333] transition-colors disabled:opacity-50">
            ...
            <div className="lg:w-[40%] space-y-10">
              <div>
                <h3 className="text-[#1a1a1a] text-xs uppercase tracking-widest mb-4">Office</h3>
              ...
              <div>
                <h3 className="text-[#1a1a1a] text-xs uppercase tracking-widest mb-4">Direct</h3>
                <p className="text-gray-600 text-sm">
                  <a href="tel:+13054559744" className="hover:text-[#1a1a1a] transition-colors">
                    (305) 455-9744
                  </a>
                </p>
                <p className="text-gray-600 text-sm mt-1">
                  <a href="mailto:andrew@iamandrewwhalen.com" className="hover:text-[#1a1a1a] transition-colors">
              ...
              <div>
                <h3 className="text-[#1a1a1a] text-xs uppercase tracking-widest mb-4">Connect</h3>
                <div className="flex gap-4">
                  {SOCIAL.map((s) => (
                    <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer"
                      className="text-gray-500 text-xs uppercase tracking-wider hover:text-[#1a1a1a] transition-colors">
                      {s.label}
                    </a>
                  ))}
                </div>
              ...
              <div className="aspect-video bg-gray-50 border border-gray-200 flex items-center justify-center">
                <p className="text-gray-500 text-sm uppercase tracking-wider">Map coming soon</p>
              </div>
            </div>
          </div>
        </div>

...
export const metadata: Metadata = {
  title: "Broward County Luxury Condos | Andrew Whalen",
  description:
    "Explore Broward County luxury condo buildings — Auberge Beach Residences, Paramount Fort Lauderdale, Ritz-Carlton Pompano Beach, and more. Andrew Whalen, South Florida luxury real estate.",
  openGraph: {
    title: "Broward County Luxury Condos | Andrew Whalen",
    description:
      "Broward County luxury condo buildings with Andrew Whalen, South Florida luxury real estate specialist.",
    type: "website",
    url: "https://iamandrewwhalen.com/luxury-condos/broward",
  },
};

export default function BrowardCondosPage() {
  const browardBuildings = buildings.filter((b) => b.county === "broward");
      ...
      <section className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-3">
          <nav className="flex items-center gap-2 text-xs text-neutral-500 uppercase tracking-wider">
            ...
            <span>/</span>
            <span className="text-gray-600">Broward County</span>
          </nav>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <p className="text-neutral-500 text-sm uppercase tracking-[0.2em] mb-10">
            {browardBuildings.length} Buildings in Broward County
          </p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {browardBuildings.map((b) => (
              <a
                key={b.slug}
      ...
      <section className="py-24 px-6 bg-gray-50">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-gray-600 mb-10">
            ...
            history for any building in Broward County.
          </p>
          <a
            href="/contact/"

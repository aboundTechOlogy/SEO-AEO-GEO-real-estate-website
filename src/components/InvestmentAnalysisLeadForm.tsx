  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <label className="space-y-2 block">
        <span className="text-xs uppercase tracking-[0.12em] text-gray-500">Property Address or Area of Interest *</span>
        <input
          name="targetProperty"
          required
          className="w-full bg-white border border-gray-200 px-4 py-3 text-[#1a1a1a] placeholder-gray-400 focus:border-gray-400 outline-none transition-colors"
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <label className="space-y-2">
          <span className="text-xs uppercase tracking-[0.12em] text-gray-500">Investment Type</span>
          <select
            name="investmentType"
            defaultValue=""
        ...
        <label className="space-y-2">
          <span className="text-xs uppercase tracking-[0.12em] text-gray-500">Budget Range</span>
          <select
            name="budgetRange"
            defaultValue=""
            className="w-full bg-white border border-gray-200 px-4 py-3 text-[#1a1a1a] focus:border-gray-400 outline-none transition-colors"

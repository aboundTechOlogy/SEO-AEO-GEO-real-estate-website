    ...
    <>
      ...
      {open && mounted && createPortal(
        <div className="fixed inset-0 z-[100]">
          ...
          <div className="absolute right-0 top-0 bottom-0 w-full md:w-[65%] lg:w-[60%] bg-neutral-900 overflow-y-auto">
            ...
            <div className="relative z-10">
              ...
              <div className="px-6 md:px-8 py-6">
                <div className="flex items-start gap-3 text-sm text-neutral-400">
                  <svg className="w-4 h-4 mt-0.5 shrink-0 text-neutral-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
              ...
              {/* Contact + Social */}
              <div className="px-6 md:px-8 py-8 flex flex-col items-center gap-6">
                <div className="space-y-3 text-center">
                  <a href="tel:+13054206613" className="flex items-center justify-center gap-3 text-neutral-300 hover:text-white transition-colors text-lg">
                  ...
                  <a href="mailto:andrew@iamandrewwhalen.com" className="flex items-center justify-center gap-3 text-neutral-300 hover:text-white transition-colors">
                    <svg className="w-5 h-5 text-neutral-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                ...
                <div className="flex items-center gap-4">
                  {SOCIAL_LINKS.map((s) => (
                    <a
                      ...
                      className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-neutral-400 hover:text-white hover:border-white/40 transition-all"
                      aria-label={s.label}
                    >

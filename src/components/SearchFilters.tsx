    ...
    <FilterDropdown
      ...
      trigger={
        <span className="flex items-center gap-1.5">
          <svg className="w-6 h-6 shrink-0" viewBox="0 0 1024 1024" fill="currentColor">
...
function PriceFilter({ open, onToggle }: { open: boolean; onToggle: () => void }) {
  ...
  return (
    <FilterDropdown
      ...
      trigger={
        <span className="flex items-center gap-1.5">
          <svg className="w-4 h-4 shrink-0" viewBox="0 0 583 1024" fill="currentColor">
            <g transform="scale(1,-1) translate(0,-1024)">
...
function BedBathFilter({ open, onToggle }: { open: boolean; onToggle: () => void }) {
  ...
  return (
    <FilterDropdown
      ...
      trigger={
        <span className="flex items-center gap-1.5">
          <svg className="w-[22px] h-[22px] shrink-0" viewBox="0 0 1024 1024" fill="currentColor">
            <g transform="scale(1,-1) translate(0,-1024)">
...
function MoreFilter({ open, onToggle }: { open: boolean; onToggle: () => void }) {
  ...
  return (
    <FilterDropdown
      ...
      trigger={
        <span className="flex items-center gap-1.5">
          <svg className="w-[17px] h-[17px] shrink-0" viewBox="0 0 1024 1024" fill="currentColor">
            <g transform="scale(1,-1) translate(0,-1024)">
...
export function DesktopSearchBar({
  ...
  return (
    <div className="hidden md:flex items-center gap-3 px-[15px] pt-[20px] pb-[10px]">
      {/* Search input */}

    ...
    <FilterDropdown
      ...
      trigger={
        <span className="flex items-center gap-1.5">
          <svg className="w-[18px] h-[18px] md:w-6 md:h-6 shrink-0" viewBox="0 0 1024 1024" fill="currentColor">
...
function BedBathFilter({ open, onToggle }: { open: boolean; onToggle: () => void }) {
  ...
  return (
    <FilterDropdown
      ...
      trigger={
        <span className="flex items-center gap-1.5">
          <svg className="w-[18px] h-[18px] md:w-[22px] md:h-[22px] shrink-0" viewBox="0 0 1024 1024" fill="currentColor">
            <g transform="scale(1,-1) translate(0,-1024)">

...
export const neighborhoods: NeighborhoodData[] = [
  ...
  /* ── Additional Miami-Dade Neighborhoods ── */

  {
    slug: "doral",
    name: "Doral",
    tagline: "Master-Planned Golf Community",
    heroDescription: "A master-planned community in western Miami-Dade known for world-class golf resorts, top-rated schools, and proximity to Miami International Airport.",
    overview: "Doral is a rapidly growing city in western Miami-Dade County anchored by the iconic Trump National Doral golf resort. Known for excellent A-rated schools, diverse international dining, and well-maintained gated communities, Doral attracts a large Latin American executive population.",
    buyerProfile: "International families, Latin American executives, and professionals seeking top schools, gated communities, and convenient airport access.",
    lifestyle: "Golf at Trump National Doral, top-rated schools, international dining, and a suburban family lifestyle with easy access to Miami International Airport.",
    priceRange: { low: "$400K", high: "$3M", median: "$650K" },
    stats: { medianPrice: "$650,000", avgDom: "55", pricePerSqft: "$380", activeInventory: "400+" },
    faqs: [],
    highlights: ["Trump National Doral golf resort", "Top-rated public schools", "5 miles from Miami International Airport", "Diverse international community", "Gated communities"],
    zipCodes: ["33122", "33178"],
    propertyTypes: ["HOMES", "CONDOS"],
    county: "miami-dade",
  },
  {
    ...
    tagline: "Art, Architecture & Luxury Retail",
    heroDescription: "Miami's premier luxury shopping and contemporary art destination, home to flagship stores, galleries, and architecturally significant buildings.",
    overview: "The Miami Design District is a world-class neighborhood dedicated to luxury retail, art, and design. Home to flagship stores from Louis Vuitton, Dior, Hermès, Chanel, and over 130 luxury brands, plus major art galleries and architecturally curated buildings designed by Pritzker Prize-winning architects.",
    buyerProfile: "Creative professionals, art collectors, and buyers seeking boutique loft-style residences in walking distance to world-class dining and art.",
    lifestyle: "Gallery walks, world-class dining at COTE and L'Atelier, luxury shopping, and an international art scene during Art Basel and Design Miami.",
    priceRange: { low: "$500K", high: "$8M", median: "$900K" },
    stats: { medianPrice: "$900,000", avgDom: "60", pricePerSqft: "$600", activeInventory: "80+" },
    faqs: [],
    highlights: ["130+ luxury flagship stores", "Pritzker Prize-winning architecture", "Major contemporary art galleries", "Design Miami headquarters", "Near Wynwood and Edgewater"],
    zipCodes: ["33137"],
    propertyTypes: ["HOMES", "CONDOS"],
    county: "miami-dade",
  },
  {
    slug: "little-havana",
    name: "Little Havana",
    tagline: "Cultural Heart of Miami",
    heroDescription: "The cultural heart of Miami's Cuban-American community, known for Calle Ocho, vibrant street life, and an increasingly dynamic real estate market.",
    overview: "Little Havana is Miami's most culturally significant neighborhood, a living monument to the Cuban diaspora. Calle Ocho (SW 8th Street) is lined with cigar shops, cafeterias, domino parks, and restaurants. The neighborhood is experiencing rising demand from buyers attracted by its authenticity, proximity to Brickell, and strong community identity.",
    buyerProfile: "Buyers seeking character and cultural vibrancy, investors attracted by proximity to Brickell and lower price points, and young professionals priced out of adjacent neighborhoods.",
    lifestyle: "Calle Ocho cultural corridor, live music, Domino Park, authentic Cuban dining, and proximity to Brickell's urban amenities.",
    priceRange: { low: "$300K", high: "$2M", median: "$500K" },
    stats: { medianPrice: "$500,000", avgDom: "50", pricePerSqft: "$380", activeInventory: "150+" },
    faqs: [],
    highlights: ["Calle Ocho — iconic cultural corridor", "Domino Park", "Proximity to Brickell", "Authentic Cuban cultural heritage", "Rising investment market"],
    zipCodes: ["33135"],
    propertyTypes: ["HOMES", "CONDOS"],
    county: "miami-dade",
  },
  {
    slug: "south-beach",
    name: "South Beach",
    tagline: "The Iconic Miami Address",
    heroDescription: "Miami Beach's iconic southern tip, famous for Art Deco architecture, Ocean Drive, and some of South Florida's most sought-after oceanfront residences.",
    overview: "South Beach is the world-famous entertainment and lifestyle district of Miami Beach, defined by its Art Deco Historic District, Ocean Drive, and a global reputation for nightlife, beaches, and culture. The residential market ranges from restored Art Deco apartments to ultra-luxury towers in the South of Fifth enclave.",
    buyerProfile: "International buyers, pied-à-terre seekers, entertainment and hospitality professionals, and investors attracted to short-term rental potential in the SoBe district.",
    lifestyle: "Ocean Drive promenade, world-famous beaches, Art Basel each December, rooftop bars and nightclubs, and the cultural energy of one of the world's most recognized addresses.",
    priceRange: { low: "$300K", high: "$60M", median: "$750K" },
    stats: { medianPrice: "$750,000", avgDom: "75", pricePerSqft: "$750", activeInventory: "800+" },
    faqs: [],
    highlights: ["Art Deco Historic District", "Ocean Drive", "World-famous beaches", "Art Basel and cultural events", "South of Fifth ultra-luxury enclave"],
    zipCodes: ["33139"],
    propertyTypes: ["HOMES", "CONDOS"],
    county: "miami-dade",
  },
  {
    slug: "wynwood",
    name: "Wynwood",
    tagline: "Miami's Premier Arts District",
    heroDescription: "Miami's premier arts district, transformed from a warehouse neighborhood into a globally recognized hub for street art, galleries, restaurants, and creative lofts.",
    overview: "Wynwood is Miami's internationally acclaimed arts district, anchored by the Wynwood Walls — the world's largest permanent collection of outdoor murals. Once purely commercial warehouse space, the neighborhood now features world-class restaurants, boutique hotels, breweries, and a growing residential scene of converted lofts and new condo developments.",
    buyerProfile: "Creative professionals, artists, tech workers, and investors seeking a culturally vibrant urban neighborhood with strong appreciation potential.",
    lifestyle: "Wynwood Walls street art, monthly Art Walk, craft cocktails, farm-to-table dining, and proximity to the Design District and Midtown.",
    priceRange: { low: "$400K", high: "$5M", median: "$600K" },
    stats: { medianPrice: "$600,000", avgDom: "58", pricePerSqft: "$520", activeInventory: "200+" },
    faqs: [],
    highlights: ["Wynwood Walls — global street art landmark", "Monthly Art Walk events", "World-class restaurants and bars", "Growing residential development", "Near Design District and Midtown"],
    zipCodes: ["33127"],
    propertyTypes: ["HOMES", "CONDOS"],
    county: "miami-dade",
  },
  {
    slug: "midtown",
    name: "Midtown",
    tagline: "Urban Living Between Two Worlds",
    heroDescription: "A vibrant mixed-use neighborhood between Wynwood and Edgewater, offering walkable urban living with modern condos, boutique retail, and diverse dining.",
    overview: "Midtown Miami is a planned urban neighborhood between Wynwood and Edgewater, anchored by Midtown Miami retail and restaurant corridor. The neighborhood offers modern condo towers at prices below Brickell and Edgewater, with easy walking access to Wynwood's art scene and the Design District's luxury stores.",
    buyerProfile: "Young urban professionals, buyers seeking walkable mixed-use living at accessible prices, and investors targeting the Wynwood/Design District adjacency premium.",
    lifestyle: "Walkable retail and dining corridor, proximity to Wynwood art galleries and Design District shops, and an emerging residential community.",
    priceRange: { low: "$350K", high: "$3M", median: "$520K" },
    stats: { medianPrice: "$520,000", avgDom: "55", pricePerSqft: "$480", activeInventory: "250+" },
    faqs: [],
    highlights: ["Midtown Miami retail corridor", "Walking distance to Wynwood Walls", "Near Design District flagship stores", "Modern condo towers", "Urban walkable lifestyle"],
    zipCodes: ["33137"],
    propertyTypes: ["HOMES", "CONDOS"],
    county: "miami-dade",
  },
...

  {
    ...
    heroDescription: "Broward County's largest city, known as the 'Venice of America' for its extensive canal system, boating lifestyle, and Las Olas Boulevard's luxury dining and shopping.",
    overview: "Fort Lauderdale is the cultural and economic capital of Broward County, offering a sophisticated urban lifestyle along its legendary 165-mile canal system. Las Olas Boulevard anchors the city's dining and retail scene, while Fort Lauderdale Beach draws international visitors. The city is home to one of the world's busiest cruise ports and a vibrant luxury real estate market.",
    buyerProfile: "Boating enthusiasts seeking canal-front homes with ocean access, professionals working in the Broward market, and buyers relocating from Miami seeking more space at lower prices.",
    lifestyle: "Boating on 165 miles of canals, dining on Las Olas Boulevard, beach days, and a sophisticated nightlife scene that's more laid-back than Miami.",
    priceRange: { low: "$300K", high: "$20M", median: "$750K" },
    stats: { medianPrice: "$750,000", avgDom: "65", pricePerSqft: "$480", activeInventory: "1,200+" },
    faqs: [],
    highlights: ["165 miles of canals — 'Venice of America'", "Las Olas Boulevard dining and shopping", "Fort Lauderdale Beach", "World's busiest cruise port", "Brightline rail to Miami"],
    zipCodes: ["33301", "33304", "33305", "33315"],
    propertyTypes: ["HOMES", "CONDOS"],
    county: "broward",
  },
  {
    slug: "hollywood",
    name: "Hollywood",
    tagline: "Broadwalk by the Beach",
    heroDescription: "A beachfront city offering a more relaxed pace than Miami, with the iconic Hollywood Beach Broadwalk, diverse dining, and increasingly upscale waterfront developments.",
    overview: "Hollywood is a coastal city between Fort Lauderdale and Miami, anchored by the 2.5-mile Hollywood Beach Broadwalk — one of Florida's most beloved oceanfront promenades. The city offers a mix of single-family homes, condo towers, and a growing luxury residential market along the Intracoastal and ocean.",
    buyerProfile: "Buyers seeking beachfront living at prices below Miami Beach, families attracted to the relaxed Broadwalk lifestyle, and investors targeting the growing South Broward market.",
    lifestyle: "Cycling the Hollywood Beach Broadwalk, outdoor dining on the beach, Intracoastal boating, and a relaxed coastal lifestyle equidistant from Miami and Fort Lauderdale.",
    priceRange: { low: "$250K", high: "$5M", median: "$500K" },
    stats: { medianPrice: "$500,000", avgDom: "60", pricePerSqft: "$400", activeInventory: "700+" },
    faqs: [],
    highlights: ["Hollywood Beach Broadwalk — 2.5-mile oceanfront promenade", "Between Miami and Fort Lauderdale", "Growing luxury condo market", "Intracoastal waterway access", "Young Circles entertainment district"],
    zipCodes: ["33019", "33020"],
    propertyTypes: ["HOMES", "CONDOS"],
    county: "broward",
  },
  {
    slug: "pompano-beach",
    name: "Pompano Beach",
    tagline: "The Next Fort Lauderdale",
    heroDescription: "A rapidly developing coastal city north of Fort Lauderdale, attracting buyers with new luxury oceanfront condos, a revitalized fishing pier, and competitive pricing.",
    overview: "Pompano Beach is one of South Florida's fastest-growing luxury markets, undergoing a significant revitalization. New oceanfront luxury towers, a renovated pier complex with restaurants and entertainment, and competitive pricing compared to Fort Lauderdale and Boca Raton are driving demand.",
    buyerProfile: "Value-seeking luxury buyers, investors identifying early-stage appreciation potential, and boating enthusiasts attracted by the Pompano Beach inlet and marina.",
    lifestyle: "New oceanfront living, the revitalized pier and Atlantic Boulevard corridor, boating access via the Pompano Beach inlet, and a growing restaurant scene.",
    priceRange: { low: "$200K", high: "$5M", median: "$450K" },
    stats: { medianPrice: "$450,000", avgDom: "65", pricePerSqft: "$380", activeInventory: "600+" },
    faqs: [],
    highlights: ["Revitalized pier complex", "New luxury oceanfront towers", "Direct ocean inlet access for boating", "Competitive pricing vs Fort Lauderdale", "Rapid development pipeline"],
    zipCodes: ["33060", "33062"],
    propertyTypes: ["HOMES", "CONDOS"],
    county: "broward",
  },
  {
    ...
    tagline: "Where Broward Meets Miami-Dade",
    heroDescription: "A compact oceanfront city at the Broward-Miami-Dade border, home to Gulfstream Park and a growing number of luxury high-rise developments.",
    overview: "Hallandale Beach sits at the border of Broward and Miami-Dade counties, offering oceanfront living with quick access to both Aventura and Hollywood. Gulfstream Park — with its horse racing, casino, and Village at Gulfstream shopping center — anchors the city's entertainment scene.",
    buyerProfile: "Buyers seeking oceanfront condos at prices below Miami Beach and Aventura, investors attracted by proximity to both counties, and entertainment seekers drawn to Gulfstream Park.",
    lifestyle: "Oceanfront living, Gulfstream Park entertainment complex, beach access, and easy proximity to Aventura Mall and Hollywood Broadwalk.",
    priceRange: { low: "$200K", high: "$6M", median: "$450K" },
    stats: { medianPrice: "$450,000", avgDom: "65", pricePerSqft: "$400", activeInventory: "500+" },
    faqs: [],
    highlights: ["Gulfstream Park racing and casino", "Oceanfront high-rise corridor", "Miami-Dade/Broward border convenience", "Village at Gulfstream shopping", "Below-market oceanfront pricing"],
    zipCodes: ["33009"],
    propertyTypes: ["HOMES", "CONDOS"],
    county: "broward",
  },
  {
    slug: "parkland",
    name: "Parkland",
    tagline: "Broward's Premier Family Community",
    heroDescription: "An affluent suburban community in western Broward County, consistently ranked among Florida's safest cities with top-rated schools and estate-sized homes.",
    overview: "Parkland is a planned residential community in western Broward County widely considered one of Florida's premier family destinations. With an A-rated school system, strict zoning that preserves a semi-rural character, gated communities, and estates on large lots, Parkland attracts buyers prioritizing quality of life over urban access.",
    buyerProfile: "Families seeking top-rated schools and a safe suburban environment, professionals wanting estate-style homes at prices below South Florida's coastal markets.",
    lifestyle: "Top-rated schools, gated communities, equestrian trails, golf courses, and a quiet semi-rural suburban lifestyle in western Broward.",
    priceRange: { low: "$500K", high: "$5M", median: "$900K" },
    stats: { medianPrice: "$900,000", avgDom: "55", pricePerSqft: "$350", activeInventory: "200+" },
    faqs: [],
    highlights: ["Ranked among Florida's safest cities", "A-rated school system", "Gated communities and large estates", "Equestrian trails", "Quiet semi-rural atmosphere"],
  ...
  },
  {
    ...
    heroDescription: "A master-planned suburban community known for excellent schools, family-friendly parks, and well-maintained gated communities in western Broward.",
    overview: "Weston is a master-planned city in western Broward County consistently ranked among the best places to live in Florida. Developed primarily by Arvida, it features beautifully landscaped neighborhoods, top-rated A schools, extensive parks, and a strong community identity. The city's infrastructure and planning make it one of South Florida's most livable suburban communities.",
    buyerProfile: "Families prioritizing top schools and community quality, Latin American families seeking a prestigious Broward County address, and buyers who prefer structured suburban living.",
    lifestyle: "Master-planned parks and trails, A-rated schools, gated communities, community events, and a polished suburban lifestyle.",
    priceRange: { low: "$400K", high: "$4M", median: "$700K" },
    stats: { medianPrice: "$700,000", avgDom: "55", pricePerSqft: "$330", activeInventory: "250+" },
    faqs: [],
    highlights: ["Consistently ranked best places to live in Florida", "Top-rated A school system", "Beautifully landscaped master-planned neighborhoods", "Extensive parks and trails", "Strong community identity"],
    zipCodes: ["33326", "33327"],
    propertyTypes: ["HOMES", "CONDOS"],
    county: "broward",
  },
...

  {
    slug: "palm-beach",
    name: "Palm Beach",
    tagline: "The Crown Jewel of South Florida",
    heroDescription: "The crown jewel of South Florida luxury, this barrier island is home to historic mansions, Worth Avenue's world-class shopping, and some of the highest property values in the country.",
    overview: "Palm Beach is an island town of about 9,000 full-time residents that stands among the world's most exclusive addresses. Worth Avenue rivals Rodeo Drive for luxury retail, the Breakers Hotel defines old-money grandeur, and estate homes on the oceanfront regularly trade above $50M. The island attracts a global roster of billionaires, celebrities, and established families.",
    buyerProfile: "Ultra-high-net-worth buyers, established wealth seeking a prestigious primary or secondary residence, and those drawn to Palm Beach society and the island's storied history.",
    lifestyle: "Worth Avenue shopping, The Breakers Hotel and Beach Club, private clubs, charity galas, the Society of the Four Arts, and an impeccably curated island lifestyle.",
    priceRange: { low: "$1M", high: "$200M", median: "$5M" },
    stats: { medianPrice: "$5,000,000", avgDom: "100", pricePerSqft: "$1,500", activeInventory: "200+" },
    faqs: [],
    highlights: ["Worth Avenue — world-class luxury retail", "The Breakers Hotel landmark", "Oceanfront estates regularly above $50M", "Private clubs and Palm Beach society", "Global billionaire community"],
    zipCodes: ["33480"],
    propertyTypes: ["HOMES", "CONDOS"],
    county: "palm-beach",
  },
  {
    slug: "boca-raton",
    name: "Boca Raton",
    tagline: "Planned Luxury Living",
    heroDescription: "An upscale coastal city known for its pristine beaches, championship golf courses, Mizner Park, and a strong mix of luxury waterfront and gated community living.",
    overview: "Boca Raton is one of South Florida's most polished cities, known for the iconic Boca Raton Resort & Club, championship golf at multiple private courses, and Mizner Park's upscale shopping and dining. The city appeals to a broad luxury buyer pool from young professionals to retirees and families.",
    buyerProfile: "Affluent families seeking top schools and gated communities, retirees drawn to golf and country club living, and professionals targeting the strong Boca Raton corporate market.",
    lifestyle: "Golf at exclusive country clubs, shopping and dining at Mizner Park, Boca Raton Beach Club, top-rated schools, and a refined suburban coastal lifestyle.",
    priceRange: { low: "$300K", high: "$20M", median: "$700K" },
    stats: { medianPrice: "$700,000", avgDom: "60", pricePerSqft: "$450", activeInventory: "900+" },
    faqs: [],
    highlights: ["Boca Raton Resort & Club landmark", "Mizner Park shopping and dining", "Championship golf at multiple private clubs", "Top-rated schools", "Pristine beaches"],
    zipCodes: ["33432", "33433", "33486"],
    propertyTypes: ["HOMES", "CONDOS"],
    county: "palm-beach",
  },
  {
    slug: "delray-beach",
    name: "Delray Beach",
    tagline: "Downtown by the Beach",
    heroDescription: "A vibrant Atlantic Avenue arts and dining scene, award-winning beaches, and a walkable downtown making it one of Palm Beach County's most desirable coastal communities.",
    overview: "Delray Beach has been named 'Most Fun Small City in America' and its walkable Atlantic Avenue district backs up the reputation. The city offers a thriving arts scene, award-winning beaches, Old School Square cultural campus, and a downtown that genuinely competes with any in South Florida for dining and entertainment quality.",
    buyerProfile: "Active lifestyle buyers, arts and culture enthusiasts, second-home seekers from the Northeast, and young professionals attracted to the walkable Atlantic Avenue scene.",
    lifestyle: "Atlantic Avenue dining and nightlife, award-winning beaches, tennis at the Delray Beach Open stadium, and a walkable downtown with galleries, boutiques, and restaurants.",
    priceRange: { low: "$250K", high: "$10M", median: "$600K" },
    stats: { medianPrice: "$600,000", avgDom: "60", pricePerSqft: "$420", activeInventory: "700+" },
    faqs: [],
    highlights: ["Atlantic Avenue — walkable dining and arts district", "Award-winning Blue Flag beaches", "Delray Beach Open tennis venue", "Old School Square cultural campus", "'Most Fun Small City in America'"],
    zipCodes: ["33444", "33483"],
    propertyTypes: ["HOMES", "CONDOS"],
    county: "palm-beach",
  },
  {
    ...
    tagline: "Palm Beach County's Urban Core",
    heroDescription: "Palm Beach County's urban center, offering waterfront dining on Clematis Street, a thriving arts scene, and increasingly sophisticated condo and townhome developments.",
    overview: "West Palm Beach is the commercial and cultural capital of Palm Beach County, sitting directly across the Intracoastal from Palm Beach island. Clematis Street and CityPlace anchor the dining and entertainment scene, while the Norton Museum of Art and the vibrant performing arts center define its cultural identity. The city is undergoing a significant residential development boom.",
    buyerProfile: "Urban professionals, buyers seeking Intracoastal views at below-Palm Beach prices, young residents attracted to the Clematis Street scene, and investors targeting the development wave.",
    lifestyle: "Clematis Street waterfront dining, Norton Museum of Art, SunFest music festival, Brightline rail access to Miami and Fort Lauderdale, and a revitalized urban downtown.",
    priceRange: { low: "$200K", high: "$10M", median: "$500K" },
    stats: { medianPrice: "$500,000", avgDom: "60", pricePerSqft: "$380", activeInventory: "600+" },
    faqs: [],
    highlights: ["Clematis Street waterfront dining and entertainment", "Norton Museum of Art", "Brightline rail station", "Views of Palm Beach island across the Intracoastal", "SunFest music festival"],
    zipCodes: ["33401", "33405", "33407"],
    propertyTypes: ["HOMES", "CONDOS"],
    county: "palm-beach",
  },
  {
    slug: "jupiter",
    name: "Jupiter",
    tagline: "Laid-Back Coastal Luxury",
    heroDescription: "A northern Palm Beach County coastal town known for Jupiter Inlet, world-class fishing, Roger Dean Stadium, and laid-back luxury living with excellent schools.",
    overview: "Jupiter is a coastal town in northern Palm Beach County celebrated for its natural beauty, excellent fishing on the Jupiter Inlet, and a more relaxed pace than South Palm Beach. Home to Roger Dean Chevrolet Stadium (spring training for the Cardinals and Marlins), Jonathan Dickinson State Park, and a thriving golf community.",
    buyerProfile: "Active outdoor lifestyle buyers, retirees seeking a quieter coastal community, families attracted to excellent schools, and buyers priced out of Palm Beach wanting a similar lifestyle.",
    lifestyle: "Fishing at Jupiter Inlet, golf at multiple courses, spring training baseball, Jonathan Dickinson State Park, and a relaxed coastal lifestyle.",
    priceRange: { low: "$300K", high: "$10M", median: "$650K" },
    stats: { medianPrice: "$650,000", avgDom: "65", pricePerSqft: "$400", activeInventory: "500+" },
    faqs: [],
    highlights: ["Jupiter Inlet — world-class fishing", "Roger Dean Stadium — spring training", "Jonathan Dickinson State Park", "Multiple golf courses", "Excellent school district"],
    zipCodes: ["33458", "33477"],
    propertyTypes: ["HOMES", "CONDOS"],
    county: "palm-beach",
  },
  {
    slug: "highland-beach",
    name: "Highland Beach",
    tagline: "Exclusive Oceanfront Enclave",
    heroDescription: "An exclusive oceanfront community between Boca Raton and Delray Beach, offering private beach access and some of the most prestigious waterfront addresses in Palm Beach County.",
    overview: "Highland Beach is a small, exclusive town of about 4,000 residents on a 2.5-mile oceanfront strip between Boca Raton and Delray Beach. With its own town government, private beach access for all residents, and a collection of luxury oceanfront and Intracoastal condominiums, Highland Beach offers an unusually high level of exclusivity for Palm Beach County.",
    buyerProfile: "Retirees and second-home buyers seeking private oceanfront living, buyers who want Boca Raton proximity with greater exclusivity, and affluent snowbirds from the Northeast.",
    lifestyle: "Private oceanfront beach, condominium luxury living, proximity to Boca Raton and Delray Beach dining, and a quiet, exclusive residential community.",
    priceRange: { low: "$400K", high: "$10M", median: "$900K" },
    stats: { medianPrice: "$900,000", avgDom: "80", pricePerSqft: "$550", activeInventory: "100+" },
    faqs: [],
    highlights: ["2.5-mile exclusive oceanfront community", "Private beach access for all residents", "Between Boca Raton and Delray Beach", "Own town government", "Luxury oceanfront and Intracoastal condos"],
    zipCodes: ["33487"],
    propertyTypes: ["CONDOS"],
    county: "palm-beach",
  },
